    ...
    "whitelist": {
        ...
        "url_backup": {
            ...
            "result": {
                ...
                "header": {
                    "Content-Type": [
                        "application\/x-sql", "application\/x-gzip", "text\/plain", "application\/x-bzip", "application\/bacnet-xdd+zip", "application\/x-gtar", "application\/x-compressed", "application\/x-rar-compressed", "application\/x-tar", "application\/zip", "application\/force-download", "application\/.*file", "application\/.*zip", "application\/.*rar", "application\/.*tar", "application\/.*down"
                    ]
                }
            }
        },
        "url_log": {
            ...
            "result": {
                ...
                "header": {
                    "Content-Type": [
                        "text\/html", "text\/plain", "application\/x-sql"
                    ]
                },
                "reg": [
